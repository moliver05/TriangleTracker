...
describe('Triangle', function()
{
    ...
    it('should correctly determine if a triangle is equilateral', function() {
        expect(reusableTriangle.checkType()).toEqual('an equilateral triangle');
    });
    ...
    it('should correctly determine whethere three lengths can be made into triangle', function () {
